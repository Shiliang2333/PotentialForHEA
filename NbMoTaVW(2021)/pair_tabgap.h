...
PairStyle(tabgap, PairTabGAP)

#else

#ifndef LMP_PAIR_TABGAP_H
#define LMP_PAIR_TABGAP_H
...
class PairTabGAP : public Pair {
public:
  PairTabGAP(class LAMMPS *);
  virtual ~PairTabGAP();
...
protected:
  ...
  void grab(FILE *, int, double *);
    ...
    E: Cannot open TabGAP potential file %s

    The specified TabGAP potential file cannot be opened.  Check that the
    path and name are correct.

    E: Invalid TabGAP potential file
